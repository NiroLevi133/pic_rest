...
function LabContent() {
  ...
  const DEFAULT_MULTI_PROMPTS = [
    `Using the reference image, preserve the EXACT appearance and identity of the person with absolute fidelity. The generated image must look like the SAME real person from the reference image — not a reinterpretation, not a similar person, and not an AI redesign. Preserve exactly: face shape, facial features, eyes, nose, lips, jawline, hairstyle, hair color, skin tone, body proportions, natural expression, posture, hand structure, realism, and full identity accuracy. The person must remain maximally identical to the original reference image. Scene setup: Create a professional photography studio environment with clean minimal aesthetics. Use soft cinematic studio lighting focused naturally on the subject with balanced realistic shadows. The background should be elegant, minimal, and non-distracting, with a premium Instagram-style editorial composition. Framing requirement: FULL BODY portrait shot. The entire body must be visible from head to toe inside the frame while keeping realistic body proportions and natural posture. Clothing requirement: Always dress the person in the EXACT same outfit across all generated studio images: oversized plain white t-shirt, classic blue jeans, no logos, no prints, no patterns, no jackets, no hats, no jewelry, no extra accessories. The clothing must look natural and realistic on the original person while preserving exact body proportions. Style and realism: Ultra realistic human realism, authentic skin texture, realistic pores, natural lighting, realistic shadows, subtle cinematic quality, DSLR photography look, photorealistic, highly detailed, enhanced sharpness and clarity, 4K ultra detailed, professional studio photography, 9:16 aspect ratio. DO NOT: change identity, redesign the person, beautify excessively, alter facial structure, change ethnicity, change age, create AI-looking skin, over-smooth the face, add fantasy elements, add accessories, or create unrealistic symmetry. The goal is ONLY to create a cleaner professional studio portrait while maintaining absolute identity consistency with the original human subject.`,
    `Using the reference image, preserve the EXACT appearance and identity of the person with absolute fidelity. The generated image must look like the SAME real person from the reference image — not a reinterpretation, not a similar person, and not an AI redesign. Preserve exactly: face shape, facial features, eyes, nose, lips, jawline, hairstyle, hair color, skin tone, natural expression, realism, and full identity accuracy. The person must remain maximally identical to the original reference image. Scene setup: Create a professional photography studio environment with clean minimal aesthetics. Use soft cinematic studio lighting focused naturally on the face with balanced realistic shadows. The background should be elegant, minimal, and softly blurred to maintain focus on the subject. Framing requirement: CLOSE-UP FACE PORTRAIT. The frame should focus mainly on the face and upper shoulders while preserving realistic facial proportions and natural human details. The person should look directly toward the camera with a calm natural expression. Clothing requirement: Always dress the person in the EXACT same outfit across all generated studio images: oversized plain white t-shirt, classic blue jeans, no logos, no prints, no patterns, no jackets, no hats, no jewelry, no extra accessories. The clothing must remain consistent with the other studio images, even if only partially visible in frame. Style and realism: Ultra realistic human realism, authentic skin texture, realistic pores, natural lighting, realistic shadows, subtle cinematic quality, DSLR photography look, photorealistic, highly detailed, enhanced sharpness and clarity, 4K ultra detailed, professional studio photography, 9:16 aspect ratio. DO NOT: change identity, redesign the person, beautify excessively, alter facial structure, change ethnicity, change age, create AI-looking skin, over-smooth the face, add fantasy elements, add accessories, or create unrealistic symmetry. The goal is ONLY to create a cleaner professional studio portrait while maintaining absolute identity consistency with the original human subject.`,
    `Using the reference image, preserve the EXACT appearance and identity of the person with absolute fidelity. The generated image must look like the SAME real person from the reference image — not a reinterpretation, not a similar person, and not an AI redesign. Preserve exactly: face shape, facial features, eyes, eye shape, eye spacing, eyebrows, nose, lips, jawline, cheek structure, forehead shape, hairline, hairstyle, hair color, skin tone, natural skin texture, skin texture, shoulder width, neck proportions, collar area proportions, upper-body proportions, waist-area proportions, natural expression, natural posture, realism, and full identity accuracy. The person must remain maximally identical to the original reference image. Identity preservation has the highest priority over all other instructions. If any conflict occurs between styling, clothing, lighting, composition, beauty enhancement, garment rendering, camera angle, or identity preservation, identity preservation must always win. The generated person must remain indistinguishable from the reference image. This image must appear to be part of the same professional photoshoot session as all other generated images of this person. Maintain identical identity, facial structure, age appearance, skin characteristics, hair appearance, neck proportions, shoulder proportions, upper-body proportions, waist-area proportions, and overall visual consistency across all generated images. Do not modify, enhance, beautify, optimize, or reinterpret any physical characteristic of the person beyond what is visible in the reference image. Scene setup: Create a professional photography studio environment with clean minimal aesthetics. Use soft cinematic studio lighting focused naturally on the subject, with balanced realistic shadows and premium editorial portrait quality. The background should be elegant, minimal, softly blurred, and completely non-distracting. The overall image should feel like a premium Instagram-style fashion editorial portrait. Framing requirement: Create a HALF-BODY PORTRAIT. The frame should show the person from approximately the upper-waist or chest area and up. The face, neck, shoulders, upper chest, upper torso, and waist area must remain visible. Keep realistic proportions, correct anatomy, accurate scale, relaxed posture, and natural positioning. The person should face slightly toward the camera with a calm, authentic, natural expression. Do not crop the head. Do not crop important parts of the shoulders. Do not distort the neck area. Use a vertical 9:16 aspect ratio. Expression requirement: Maintain a calm, authentic, relaxed, and natural human expression. Do not create exaggerated smiles. Do not create dramatic emotions. Do not create artificial beauty-campaign expressions. Do not create fashion-model exaggerations. The expression should feel genuine and naturally human. Clothing requirement: Always dress the person in: oversized plain white t-shirt, classic blue jeans. The visible clothing must fit naturally on the original person while preserving realistic fabric behavior, natural folds, correct garment scale, and believable contact with the body. The visible clothing should look naturally worn by the same person from the reference image, not pasted on, not floating, not warped, and not digitally distorted. Visible upper-body clothing and visible waist-area garments should be considered in this half-body portrait format. Garment accuracy rules: No additional clothing items unless explicitly provided by the user. No extra logos. No added prints. No added patterns. No jackets. No hats. No jewelry. No bags. No sunglasses. No extra accessories. When a garment product image is provided, garment accuracy has higher priority than fashion styling. Do not improve, redesign, reinterpret, modernize, simplify, or creatively modify the uploaded garment. Exact garment replication is required. If a product image is provided, replicate the uploaded garment with maximum accuracy, including: color, fabric, texture, fit, cut, silhouette, stitching, seams, collar shape, neckline, sleeve length, buttons, pockets, zipper details, waistband, belt area, branding placement, logos, printed graphics, patterns, fabric draping, fabric thickness, fabric behavior, and all visible design details. The final clothing must match the uploaded product image as accurately as possible while fitting naturally on the original person. Style and realism: Ultra-realistic human realism. Authentic skin texture. Realistic pores. Natural skin imperfections. Natural lighting. Realistic shadows. Subtle cinematic quality. DSLR photography look. Photorealistic. Highly detailed. Enhanced sharpness and clarity. 4K ultra-detailed. Professional studio photography. The final image should resemble a professional e-commerce fashion catalog photograph rather than an artistic fashion campaign. Prioritize accurate product presentation, consistency, realism, garment visibility, and identity preservation. DO NOT: change identity, redesign the person, create a similar-looking person, beautify excessively, alter facial structure, change ethnicity, change age, change skin tone, change hairstyle, change hair color, change neck proportions, change shoulder proportions, change upper-body proportions, change waist-area proportions, over-smooth the skin, remove natural facial characteristics, create AI-looking skin, add fantasy elements, add accessories, add jewelry, add hats, add bags, add sunglasses, add extra clothing layers, create unrealistic symmetry, distort facial proportions, distort eyes, distort lips, distort shoulders, distort the neck area, distort clothing, crop the head, or crop important upper-body areas. Goal: Create a clean, professional, half-body studio portrait while maintaining absolute identity consistency with the original human subject, accurate garment presentation, and complete visual consistency with the rest of the photoshoot series. Clothing replacement logic — No uploaded clothing: dress the person in oversized plain white t-shirt, classic blue jeans. Shirt uploaded: dress the person in the exact shirt from the shirt product image, classic blue jeans. Pants uploaded: dress the person in oversized plain white t-shirt, the exact pants from the pants product image. Shirt and pants uploaded: dress the person in the exact shirt from the shirt product image, the exact pants from the pants product image. Important rule: Do not reference shoes in this format. Visible upper-body clothing and visible waist-area garments should be considered. Only the clothing section changes. All identity, lighting, framing, realism, expression, and negative instructions must remain identical across all generated images to maintain a consistent visual style.`,
    `Using the reference image, preserve the EXACT appearance and identity of the person with absolute fidelity. The generated image must look like the SAME real person from the reference image — not a reinterpretation, not a similar person, and not an AI redesign. Preserve exactly: face shape, facial features, facial side profile, eyes, eye shape, eye spacing, eyebrows, nose, nose profile, lips, jawline, jawline profile, cheek structure, forehead shape, ear shape, hairline, hairstyle, hair color, skin tone, natural skin texture, skin texture, shoulder width, neck proportions, collar area proportions, upper-body proportions, waist-area proportions, natural expression, natural posture, realism, and full identity accuracy. The person must remain maximally identical to the original reference image. Identity preservation has the highest priority over all other instructions. If any conflict occurs between styling, clothing, lighting, composition, beauty enhancement, garment rendering, camera angle, or identity preservation, identity preservation must always win. The generated person must remain indistinguishable from the reference image. This image must appear to be part of the same professional photoshoot session as all other generated images of this person. Maintain identical identity, facial structure, facial profile structure, age appearance, skin characteristics, hair appearance, neck proportions, shoulder proportions, upper-body proportions, waist-area proportions, and overall visual consistency across all generated images. Do not modify, enhance, beautify, optimize, or reinterpret any physical characteristic of the person beyond what is visible in the reference image. Scene setup: Create a professional photography studio environment with clean minimal aesthetics. Use soft cinematic studio lighting focused naturally on the subject, with balanced realistic shadows and premium editorial portrait quality. The background should be elegant, minimal, softly blurred, and completely non-distracting. The overall image should feel like a premium Instagram-style fashion editorial portrait. Framing requirement: Create a RIGHT SIDE HALF-BODY PORTRAIT. The person should be photographed primarily from the right-side angle. The frame should show the person from approximately the upper-waist or chest area and up. The face, neck, shoulders, upper chest, upper torso, and waist area must remain visible. The head should be slightly turned toward the camera to maintain identity clarity and facial recognition. The face must remain clearly recognizable despite the side-angle composition. Keep realistic proportions, correct anatomy, accurate scale, relaxed posture, and natural positioning. Do not crop the head. Do not crop important parts of the shoulders. Do not distort the neck area. Use a vertical 9:16 aspect ratio. Expression requirement: Maintain a calm, authentic, relaxed, and natural human expression. Do not create exaggerated smiles. Do not create dramatic emotions. Do not create artificial beauty-campaign expressions. Do not create fashion-model exaggerations. The expression should feel genuine and naturally human. Clothing requirement: Always dress the person in: oversized plain white t-shirt, classic blue jeans. The visible clothing must fit naturally on the original person while preserving realistic fabric behavior, natural folds, correct garment scale, and believable contact with the body. The visible clothing should look naturally worn by the same person from the reference image, not pasted on, not floating, not warped, and not digitally distorted. Visible upper-body clothing and visible waist-area garments should be considered in this half-body portrait format. Garment accuracy rules: No additional clothing items unless explicitly provided by the user. No extra logos. No added prints. No added patterns. No jackets. No hats. No jewelry. No bags. No sunglasses. No extra accessories. When a garment product image is provided, garment accuracy has higher priority than fashion styling. Do not improve, redesign, reinterpret, modernize, simplify, or creatively modify the uploaded garment. Exact garment replication is required. If a product image is provided, replicate the uploaded garment with maximum accuracy, including: color, fabric, texture, fit, cut, silhouette, stitching, seams, collar shape, neckline, sleeve length, buttons, pockets, zipper details, waistband, belt area, branding placement, logos, printed graphics, patterns, fabric draping, fabric thickness, fabric behavior, and all visible design details. The final clothing must match the uploaded product image as accurately as possible while fitting naturally on the original person. Style and realism: Ultra-realistic human realism. Authentic skin texture. Realistic pores. Natural skin imperfections. Natural lighting. Realistic shadows. Subtle cinematic quality. DSLR photography look. Photorealistic. Highly detailed. Enhanced sharpness and clarity. 4K ultra-detailed. Professional studio photography. The final image should resemble a professional e-commerce fashion catalog photograph rather than an artistic fashion campaign. Prioritize accurate product presentation, consistency, realism, garment visibility, profile accuracy, and identity preservation. DO NOT: change identity, redesign the person, create a similar-looking person, beautify excessively, alter facial structure, alter facial profile structure, change ethnicity, change age, change skin tone, change hairstyle, change hair color, change ear shape, change nose profile, change jawline profile, change neck proportions, change shoulder proportions, change upper-body proportions, change waist-area proportions, over-smooth the skin, remove natural facial characteristics, create AI-looking skin, add fantasy elements, add accessories, add jewelry, add hats, add bags, add sunglasses, add extra clothing layers, create unrealistic symmetry, distort facial proportions, distort facial profile proportions, distort eyes, distort lips, distort ears, distort shoulders, distort the neck area, distort clothing, crop the head, or crop important upper-body areas. Goal: Create a clean, professional, right-side half-body studio portrait while maintaining absolute identity consistency with the original human subject, accurate garment presentation, accurate side-profile representation, and complete visual consistency with the rest of the photoshoot series. Clothing replacement logic — No uploaded clothing: dress the person in oversized plain white t-shirt, classic blue jeans. Shirt uploaded: dress the person in the exact shirt from the shirt product image, classic blue jeans. Pants uploaded: dress the person in oversized plain white t-shirt, the exact pants from the pants product image. Shirt and pants uploaded: dress the person in the exact shirt from the shirt product image, the exact pants from the pants product image. Important rule: Do not reference shoes in this format. Visible upper-body clothing and visible waist-area garments should be considered. Only the clothing section changes. All identity, lighting, framing, realism, expression, and negative instructions must remain identical across all generated images to maintain a consistent visual style.`,
    `Using the reference image, preserve the EXACT appearance and identity of the person with absolute fidelity. The generated image must look like the SAME real person from the reference image — not a reinterpretation, not a similar person, and not an AI redesign. Preserve exactly: face shape, facial features, facial side profile, eyes, eye shape, eye spacing, eyebrows, nose, nose profile, lips, jawline, jawline profile, cheek structure, forehead shape, ear shape, hairline, hairstyle, hair color, skin tone, natural skin texture, skin texture, shoulder width, neck proportions, collar area proportions, upper-body proportions, waist-area proportions, natural expression, natural posture, realism, and full identity accuracy. The person must remain maximally identical to the original reference image. Identity preservation has the highest priority over all other instructions. If any conflict occurs between styling, clothing, lighting, composition, beauty enhancement, garment rendering, camera angle, or identity preservation, identity preservation must always win. The generated person must remain indistinguishable from the reference image. This image must appear to be part of the same professional photoshoot session as all other generated images of this person. Maintain identical identity, facial structure, facial profile structure, age appearance, skin characteristics, hair appearance, neck proportions, shoulder proportions, upper-body proportions, waist-area proportions, and overall visual consistency across all generated images. Do not modify, enhance, beautify, optimize, or reinterpret any physical characteristic of the person beyond what is visible in the reference image. Scene setup: Create a professional photography studio environment with clean minimal aesthetics. Use soft cinematic studio lighting focused naturally on the subject, with balanced realistic shadows and premium editorial portrait quality. The background should be elegant, minimal, softly blurred, and completely non-distracting. The overall image should feel like a premium Instagram-style fashion editorial portrait. Framing requirement: Create a LEFT SIDE HALF-BODY PORTRAIT. The person should be photographed primarily from the left-side angle. The frame should show the person from approximately the upper-waist or chest area and up. The face, neck, shoulders, upper chest, upper torso, and waist area must remain visible. The head should be slightly turned toward the camera to maintain identity clarity and facial recognition. The face must remain clearly recognizable despite the side-angle composition. Keep realistic proportions, correct anatomy, accurate scale, relaxed posture, and natural positioning. Do not crop the head. Do not crop important parts of the shoulders. Do not distort the neck area. Use a vertical 9:16 aspect ratio. Expression requirement: Maintain a calm, authentic, relaxed, and natural human expression. Do not create exaggerated smiles. Do not create dramatic emotions. Do not create artificial beauty-campaign expressions. Do not create fashion-model exaggerations. The expression should feel genuine and naturally human. Clothing requirement: Always dress the person in: oversized plain white t-shirt, classic blue jeans. The visible clothing must fit naturally on the original person while preserving realistic fabric behavior, natural folds, correct garment scale, and believable contact with the body. The visible clothing should look naturally worn by the same person from the reference image, not pasted on, not floating, not warped, and not digitally distorted. Visible upper-body clothing and visible waist-area garments should be considered in this half-body portrait format. Garment accuracy rules: No additional clothing items unless explicitly provided by the user. No extra logos. No added prints. No added patterns. No jackets. No hats. No jewelry. No bags. No sunglasses. No extra accessories. When a garment product image is provided, garment accuracy has higher priority than fashion styling. Do not improve, redesign, reinterpret, modernize, simplify, or creatively modify the uploaded garment. Exact garment replication is required. If a product image is provided, replicate the uploaded garment with maximum accuracy, including: color, fabric, texture, fit, cut, silhouette, stitching, seams, collar shape, neckline, sleeve length, buttons, pockets, zipper details, waistband, belt area, branding placement, logos, printed graphics, patterns, fabric draping, fabric thickness, fabric behavior, and all visible design details. The final clothing must match the uploaded product image as accurately as possible while fitting naturally on the original person. Style and realism: Ultra-realistic human realism. Authentic skin texture. Realistic pores. Natural skin imperfections. Natural lighting. Realistic shadows. Subtle cinematic quality. DSLR photography look. Photorealistic. Highly detailed. Enhanced sharpness and clarity. 4K ultra-detailed. Professional studio photography. The final image should resemble a professional e-commerce fashion catalog photograph rather than an artistic fashion campaign. Prioritize accurate product presentation, consistency, realism, garment visibility, profile accuracy, and identity preservation. DO NOT: change identity, redesign the person, create a similar-looking person, beautify excessively, alter facial structure, alter facial profile structure, change ethnicity, change age, change skin tone, change hairstyle, change hair color, change ear shape, change nose profile, change jawline profile, change neck proportions, change shoulder proportions, change upper-body proportions, change waist-area proportions, over-smooth the skin, remove natural facial characteristics, create AI-looking skin, add fantasy elements, add accessories, add jewelry, add hats, add bags, add sunglasses, add extra clothing layers, create unrealistic symmetry, distort facial proportions, distort facial profile proportions, distort eyes, distort lips, distort ears, distort shoulders, distort the neck area, distort clothing, crop the head, or crop important upper-body areas. Goal: Create a clean, professional, left-side half-body studio portrait while maintaining absolute identity consistency with the original human subject, accurate garment presentation, accurate side-profile representation, and complete visual consistency with the rest of the photoshoot series. Clothing replacement logic — No uploaded clothing: dress the person in oversized plain white t-shirt, classic blue jeans. Shirt uploaded: dress the person in the exact shirt from the shirt product image, classic blue jeans. Pants uploaded: dress the person in oversized plain white t-shirt, the exact pants from the pants product image. Shirt and pants uploaded: dress the person in the exact shirt from the shirt product image, the exact pants from the pants product image. Important rule: Do not reference shoes in this format. Visible upper-body clothing and visible waist-area garments should be considered. Only the clothing section changes. All identity, lighting, framing, realism, expression, and negative instructions must remain identical across all generated images to maintain a consistent visual style.`,
    `You are an elite commercial product photography and image editing expert. Your task is to transform the uploaded product image into a premium e-commerce product photograph that looks as if it was captured in a professional photography studio.
