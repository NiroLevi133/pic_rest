...
function LabContent() {
  ...
  const DEFAULT_MULTI_PROMPTS = [
    ...
    `Using the reference image, preserve the EXACT appearance and identity of the person with absolute fidelity. The generated image must look like the SAME real person from the reference image — not a reinterpretation, not a similar person, and not an AI redesign. Preserve exactly: face shape, facial features, eyes, nose, lips, jawline, hairstyle, hair color, skin tone, body proportions, natural expression, posture, realism, and full identity accuracy. The person must remain maximally identical to the original reference image. Scene setup: Create a professional photography studio environment with clean minimal aesthetics. Use soft cinematic studio lighting focused naturally on the subject with balanced realistic shadows. The background should be elegant, minimal, and softly blurred with a premium Instagram-style editorial composition. Framing requirement: HALF-BODY PORTRAIT. The frame should show the person from approximately the waist/chest area and up. Keep realistic body proportions, relaxed posture, and natural positioning. The person should face slightly toward the camera with a calm authentic expression. Clothing requirement: Always dress the person in the EXACT same outfit across all generated studio images: oversized plain white t-shirt, classic blue jeans, no logos, no prints, no patterns, no jackets, no hats, no jewelry, no extra accessories. The clothing must look natural and realistic on the original person while preserving exact body proportions. Style and realism: Ultra realistic human realism, authentic skin texture, realistic pores, natural lighting, realistic shadows, subtle cinematic quality, DSLR photography look, photorealistic, highly detailed, enhanced sharpness and clarity, 4K ultra detailed, professional studio photography, 9:16 aspect ratio. DO NOT: change identity, redesign the person, beautify excessively, alter facial structure, change ethnicity, change age, create AI-looking skin, over-smooth the face, add fantasy elements, add accessories, or create unrealistic symmetry. The goal is ONLY to create a cleaner professional studio portrait while maintaining absolute identity consistency with the original human subject.`,
