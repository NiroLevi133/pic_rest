...
function LabContent() {
  ...
  const DEFAULT_MULTI_PROMPTS = [
    ...
    `Using the reference image of the woman, keep the SAME woman in every generation. Maintain the same identity, same facial structure, same hair, same eyes and same overall appearance. The character should feel like a real consistent Instagram influencer with authentic human realism. Close-up portrait, ${STYLE_SUFFIX}, detailed eyes and skin texture, soft studio lighting, authentic mature facial expression, photorealistic, 4K ultra detailed`,
    `Using the reference image of the woman, keep the SAME woman in every generation. Maintain the same identity, same facial structure, same hair, same eyes and same overall appearance. The character should feel like a real consistent Instagram influencer with authentic human realism. Half body side profile portrait, ${STYLE_SUFFIX}, elegant relaxed posture, cinematic side profile angle, white studio background, photorealistic`,
    `Using the reference image of the woman, keep the SAME woman in every generation. Maintain the same identity, same facial structure, same hair, same eyes and same overall appearance. The character should feel like a real consistent Instagram influencer with authentic human realism. Half body side profile portrait from the opposite side, ${STYLE_SUFFIX}, soft professional studio lighting, cinematic realism, 4K ultra detailed`,
    `Using the reference image of the woman, keep the SAME woman in every generation. Maintain the same identity, same facial structure, same hair, same eyes and same overall appearance. The character should feel like a real consistent Instagram influencer with authentic human realism. Lifestyle portrait sitting naturally on a boho chic sofa in a cozy stylish living room, ${STYLE_SUFFIX}, warm ambient lighting, cinematic cozy atmosphere`,
  ];
